...
function(gp_resolved_file_type original_file file exepath dirs type_var)
  ...
  if(NOT is_embedded)
    if(NOT IS_ABSOLUTE "${resolved_file}")
      ...
      elseif(lower MATCHES "^(kernel32|user32|gdi32|advapi32|shell32|ole32|oleaut32|ws2_32|imm32|winmm|mpr|dnsapi|iphlpapi|crypt32|ntdll|msvcrt|version|wininet|dbghelp|opengl32|glu32|winspool|comctl32|comdlg32|shlwapi|setupapi|cfgmgr32|bcrypt|ncrypt|secur32|sspicli|rpcrt4|uuid|userenv|profapi|powrprof|devobj)\\.dll")
        message(STATUS "DEBUG: matched system dll lower="${lower}" resolved="${resolved_file}"")
        set(is_system 1)
        set(type "system")
      else()
